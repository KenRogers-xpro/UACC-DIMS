  ...
  return (
    <div className="flex flex-col gap-6 w-full animate-fadeIn pb-10">
      ...
      <AnimatePresence>
        {previewOpen && (
        <motion.div
          className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4 backdrop-blur-sm pointer-events-auto"
        ...
        >
          <motion.div
            className="card rounded-2xl w-full max-w-2xl bg-[var(--bg-surface)] flex flex-col my-8 shadow-2xl overflow-hidden relative shadow-black/50 pointer-events-auto max-h-[90vh] overflow-y-auto"

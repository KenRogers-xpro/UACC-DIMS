...
import { 
  FileText, LayoutDashboard, FolderOpen, ClipboardList, Clock, 
  BarChart2, Users, Shield, LogOut, ChevronLeft, ChevronRight, 
  Bot, Settings, BookOpen, Inbox, Calendar, MessageSquare, 
  Megaphone, X 
} from 'lucide-react'
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-2 pb-3 mt-auto flex flex-col gap-0.5"
        ...
        {showSettings && (
          ...
          >
            <Settings size={16} strokeWidth={1.5} className={`flex-shrink-0 ${pathname === '/dashboard/settings' ? 'text-uacc-gold' : ''}`} />
            {!collapsed && (

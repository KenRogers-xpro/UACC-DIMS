...
const IDLE_WARNING_MS = 15 * 1000; // TESTING OVERRIDE — restore to 29 * 60 * 1000 before final deploy
const IDLE_LOGOUT_MS = 30 * 1000; // TESTING OVERRIDE — restore to 30 * 60 * 1000 before final deploy
